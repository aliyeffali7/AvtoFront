...
export const addServiceToOrder = (orderId: number, name: string, price: number, mechanic_amount?: number | null) =>
  api.post<Order>(`/api/orders/${orderId}/services`, { name, price, mechanic_amount: mechanic_amount ?? null })
